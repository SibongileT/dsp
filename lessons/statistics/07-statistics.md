...
>> The probability Elvis had an identical twin is 45%. Using the Bayes' Theorem and taking into account that his twin was a brother it came out to 5/11 or 45%.
...
>>Frequentist and Bayesian compare because frequentist looks at the answer based off of the current experiment where as Baysian looks at prior probabilities to find it's answer.
